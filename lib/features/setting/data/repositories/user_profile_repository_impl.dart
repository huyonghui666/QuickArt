...
class UserProfileRepositoryImpl implements IUserProfileRepository {
  ...
  final IUserProfileLocalDataSource _cacheDataSource;

  @override
  Future<UserProfile> getUserProfile() async {
    final cached = await _cacheDataSource.getCachedProfile();
    if (cached != null) {
      return UserProfileModel.fromJson(cached).toEntity();
    }
    ...
    await _cacheDataSource.cacheProfile({
      'userId': model.userId,
  ...
  @override
  Future<void> clearCache() => _cacheDataSource.clearCache();
}
